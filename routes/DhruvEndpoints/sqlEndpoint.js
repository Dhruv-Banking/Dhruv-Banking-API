...
router.post("/", auth.authenticateToken, verRole.authDhruvEndpoint, async (req, res) => {
    // Get data
    ...
    if (query.toLowerCase().includes("drop")) {
        return res.status(400).send({detail: "Dhruv, I am try -- so hard to stop you from being an idiot"});
    }
